...
config = {
    ...
    "env_name": "HumanoidStandup-v5",     # fallback to v4 if needed
    "n_envs": 8,                          # parallel envs; SAC benefits from moderate parallelism
    "total_timesteps": 50_000_000,        # long horizon task
    "learning_rate": 1e-4,
    "buffer_size": 250_000,
    "batch_size": 256,
    "gamma": 0.995,
    "tau": 0.005,
    "ent_coef": "auto",                   # or "auto_0.1" for higher initial exploration
    "learning_starts": 40_000,            # ↓ from 100k so learning kicks in earlier
    "train_freq_steps": 1,                # (1, "step")
    "gradient_steps": 8,                  # ≈ n_envs; increases update ratio
    "policy_kwargs": dict(net_arch=dict(pi=[256, 256], qf=[256, 256])),
    "log_interval_steps": 5_000,          # how often to push extra scalars to W&B
    "use_vecnormalize": True,             # normalize obs/reward for Mujoco
    "clip_obs": 10.0,
    "clip_reward": 10.0,
    "seed": 0,
}
